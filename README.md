...
* Activate the environment using the following command in a terminal window:
  ...
  * Windows: `activate recommendation-system`
  * Linux, OS X: `source activate recommendation-system`
...
* Deactivate the environment using the following command in a terminal window:
  ...
  * Windows: `deactivate recommendation-system`
  * Linux, OS X: `source deactivate recommendation-system`
               
* Delete the environment using the command (can't be undone):

  * `conda remove --name recommendation-system --all`
...
│   └── recommendationsystem       <- Example python package - place shared code in such a package
...
└── tests                    <- Test cases (named after module)
    ...
    └── recommendationsystem       <- recommendationsystem tests
